...
const I18n = (() => {
  const translations = {
    pt: {
      ...
      syncCommentary: 'Sincronizar com painel bíblico',
      unsyncCommentary: 'Navegação independente',
    ...
    en: {
      ...
      syncCommentary: 'Sync with Bible pane',
      unsyncCommentary: 'Independent navigation',
    ...
    es: {
      ...
      syncCommentary: 'Sincronizar con panel bíblico',
      unsyncCommentary: 'Navegación independiente',
