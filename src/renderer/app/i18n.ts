 ...
 */
import { GRAPHE_BOOK_NUMBERS } from './book-ids.js';
...
export const I18n = (() => {
  const translations: Record<SupportedLang, Record<string, string>> = {
    pt: {
      ...
      searchHint: 'Digite sua pesquisa para buscar.',
    ...
    en: {
      ...
      searchHint: 'Type your search to find verses.',
    ...
    es: {
      ...
      searchHint: 'Escriba su búsqueda para buscar.',
  ...
  const BOOK_NUMBERS: number[] = [...GRAPHE_BOOK_NUMBERS];
